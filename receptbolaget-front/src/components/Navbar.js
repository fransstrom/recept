                            ...
                            <li>
                                {this.state.isSignedIn === true ? (
                                    ...
                                    <a onClick={this.signIn}>
                                        <span className="glyphicon glyphicon-log-in"/> Sign in with google
                                    </a>
                                )}
                            </li>
                            ...
                            {this.state.isSignedIn === true ? (
                                    ...
                                    <li className="nav-item dropdown nav_li_img">
                                        <a
                                            ...
                                            aria-haspopup="true"
                                            aria-expanded="false">
                                            <img className='google_img' src={window.gapi.auth2.getAuthInstance().currentUser.Ab.w3.Paa}/>
                                        </a>
                                        <div className="dropdown-menu" aria-labelledby="nav_img_dropdown">
                                            <ul className="nav navbar-nav">
                                                <li>
